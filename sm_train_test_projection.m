function [xtrain, xtest, xtrain_locator, xtest_locator] = sm_train_test_projection(filters, locator, stimulus, index_freq)
...
[itrain1, itrain2, itrain3, itrain4] = sm_training_set_indices(ntrials);
[itest1, itest2, itest3, itest4] = sm_test_set_indices(ntrials);
