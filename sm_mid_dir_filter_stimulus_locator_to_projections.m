function sm_mid_dir_filter_stimulus_locator_to_projections(varargin)
% sm_mid_dir_filter_stimulus_locator_to_projections Estimate and save filter projections
%
% sm_mid_dir_filter_stimulus_locator_to_projections(keyword1, value1, ...) 
% ---------------------------------------------------------------------------------
%
...
for ii = 1:length(folders)
    ...
    for i = 1:length(matfiles)
        ...
        outfile = fullfile(outfolder, strrep(matfiles{i}, '.mat', '-proj.mat'));
        fprintf('Outfile = %s\n', outfile);
        pause(5);
