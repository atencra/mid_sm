function [ifraction] = sm_train_test_info_fraction_2d(x1binedges, x2binedges, locator, x1, x2, fraction)
...
for i = 1:length(x1)
   ...
   for j = 1:length(fraction)
      ...
      [ifrac] = sm_info_fraction(x1binedges{i}, x1{i}, locator{i}, fraction(j), ... 
                              x2binedges{i}, x2{i} );
