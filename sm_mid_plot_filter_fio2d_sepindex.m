function sm_mid_plot_filter_fio2d_sepindex(data)
% sm_mid_plot_filter_fio2d Plot MID filters and 1D and 2D nonlinearities and the 
%   separable approximation to the 2D nonlinearity.
%
%    sm_mid_plot_filter_fio2d(fio) plots the filter/fio data stored in the
%       struct fio.
%
