function [rtf_fold, tmf_mtf, tmtf, smf_mtf, smtf] = sm_mtf_rtf2mtf(rtf, tmf, xmf)
% sm_mtf_rtf2mtf  Modulation transfer functions from ripple transfer functions
% 
%     [rtf_fold, tmf, tmtf, smf, smtf] = sm_mtf_rtf2mtf(rtf, tmf, xmf)
% 
%     Calculates folded RTF, and temporal/spectral modulation transfer
%     functions.
% 
...
%     tmtf : temporal MTF
%     tmf_mtf : temporal modulation frequency axis for rtf_fold, tmtf
%     smf_mtf : spectral modulation frequency axis for rtf_fold, smtf
%     smtf : spectral MTF
