function datafiles = sm_mid_dir_file_names_to_file_struct(varargin)
%  mid_dir_sm_file_names_to_file_struct - MID files for each single unit
%
%  datafiles = mid_dir_sm_file_names_to_file_struct()
%  ===============================================================
...
options = struct('savepath', '.', 'intan', 0);
